...
function installWindows() {
  // schtasks /TR is fragile when the command line contains paths with spaces
  // or quotes (e.g. "C:\Program Files\nodejs\node.exe" + a vault path with
  // spaces). Write a tiny .cmd wrapper at the install root and point the task
  // at that single file - sidesteps all the schtasks escaping landmines.
  ...
  const cmd = `schtasks /Create /F /TN "${LABEL}" /TR "\\"${wrapper}\\"" /SC ONLOGON /RL HIGHEST`
  try {
